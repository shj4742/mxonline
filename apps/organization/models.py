...
class CourseOrg(models.Model):
    ...
    category = models.CharField(max_length=20, choices=(('pxjg', '培训机构'), ('gx', '高校'), ('gr', '个人')), verbose_name='分类', default='pxjg')
    fav_nums = models.IntegerField(default=0, verbose_name=u'收藏数')
    image = models.ImageField(upload_to='org/%Y/%m', verbose_name=u'封面图', max_length=100)
    address = models.CharField(max_length=100, default='', verbose_name=u'机构地址')
...
class Teacher(models.Model):
    ...
    desc = models.TextField(verbose_name=u'自我介绍')
